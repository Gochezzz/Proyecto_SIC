        ...
        <div class="cuadroIZ">
          <q-card flat bordered class="tarjetaI" style="border-radius: 10px">
            ...
            <q-card-section style="display: flex">
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Nombre Tercero</label
                >
                <q-input v-model="datos.nombret" autogrow />
              </div>
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Código Tercero</label
                >
                <q-input v-model="datos.codigot" autogrow />
              </div>
              <div style="margin-left: 12px">
                <q-checkbox
                  v-model="cliente"
            ...
            <q-card-section style="display: flex">
              ...
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Código Soporte</label
                >
                <q-input v-model="datos.codigos" autogrow />
              </div>
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Documento</label
                >
                <q-input v-model="datos.documento" autogrow />
              </div>
            </q-card-section>
            <q-card-section style="display: flex">
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Cantidad</label
                >
                <q-input v-model="datos.cantidad" autogrow />
              </div>
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >C/U</label
                >
                <q-input v-model="datos.cu" autogrow />
              </div>
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Total</label
                >
                <q-input v-model="datos.total" autogrow />
              </div>
              <div>
                <q-btn @click="calcular" color="primary">Calcular</q-btn>
              </div>
            </q-card-section>
            <q-card-section>
              <div style="margin-left: 12px">
            ...
            <q-card-section style="display: flex">
              <div style="margin-left: 12px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Debe</label
                >
                <q-input v-model="datos.debe" autogrow dense />
              </div>
              <div style="margin-left: 42px">
                <label style="font-size: 16px; color: #0b3668; margin-top: 8px"
                  >Haber</label
                >
                <q-input v-model="datos.haber" autogrow dense />
              </div>
            </q-card-section>
...
function calcular() {
  ...
  if (Number.isFinite(cantidad) && Number.isFinite(cu)) {
    totales = cantidad * cu;
